...
<div style="padding-bottom: 44px;">
  <ul class="nav_sec" style="text-align: center">
    <li><a href="/billing" class="btn btn-danger">成立履歴</a></li>
    <li><a href="/appointments" class="btn btn-danger">依頼履歴</a></li>
	  <li><a href="/favorites" class="btn btn-danger">お気に入り</a></li>
  </ul>
</div>
<div class="container">
  ...
  <img src="<?php $partnerurl = $seconddb->get_var("SELECT partnerurl FROM vendor WHERE email='$_email'"); echo $partnerurl; ?>" style="width:20%;"><br>
