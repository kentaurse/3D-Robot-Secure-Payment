...
<main class="l-main">
	...
	<div class="row">
				...
				<form class="advance-search" method="post" action="<?php echo admin_url('admin-ajax.php'); ?>">					
					...
					<div class="row text-center">
						<div class="col">
							...
							<input type="hidden" name="pref" id="pref" value="<?php echo $_POST['talkpref']; ?>">
		...
		<div class="col-sm-13 col-md-9 col-lg-9">
		<div class="row callback-msg text-center" style="padding: 25px; display: none"><h1 class="text-center">該当企業がありません。<br>登録企業は順次増えておりますのでお待ちくださいませ。</h1></div>
		...
		<div id="js-footer-widget" class="p-footer-widget-area p-footer-widget-area__default">
			<div class="footertext l-inner">
				<a href="privacy.php" target="_blank">個人情報保護方針</a>　　　<a href="rule.php" target="_blank">サイト利用規約</a><br
					...
					target="_blank">特商法表示</a>　　　<br class="br-sp"><a href="https://www.realideal.jp/"
					target="_blank">運営会社</a>　　　<a href="want.php" target="_blank">掲載希望の方</a>
			</div>
		</div>
