...
function get_latest_theme_version( $interval ) {
    ...
    $notifier_file_url = 'http://design-plus1.com/notifier_iconic.xml';	
    $db_cache_field = 'iconic-contempo-notifier-cache';
    $db_cache_field_last_updated = 'iconic-contempo-notifier-last-updated';
