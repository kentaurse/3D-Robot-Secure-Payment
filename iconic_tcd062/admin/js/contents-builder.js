jQuery(document).ready(function($){
	...
	// カテゴリー記事一覧 タイプ変更
	$('#contents_builder').on('change', '.cb_content-category .cb_layout-radios :radio', function(){
		if (this.checked) {
			var $container = $(this).closest('.cb_content-category');
			$container.find('div[class*="cb_layout-content-"]').hide();
			$container.find('.cb_layout-content-' + this.value).show();
		}
	});
	$('#contents_builder .cb_content-category .cb_layout-radios :radio:checked').trigger('change');
});
