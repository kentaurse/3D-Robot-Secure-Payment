<?php
/**
 * Template for WCEX SKU Select 1.1
 */
				...
				<div class="p-entry-item__carts p-entry-item__body">
					<form action="<?php echo USCES_CART_URL; ?>" method="post">
						<div id="skuform" class="p-entry-item__cart">
							...
							<p class="p-entry-item__cart-stock-status"><?php _e( 'Stock status', 'tcd-w' ); ?> : <span class="ss_stockstatus"><?php usces_the_itemZaikoStatus(); ?></span></p>
<?php
		if ( usces_the_itemCprice( 'return' ) > 0 ) :
?>
							<p class="p-entry-item__cart-cprice"><?php _e( 'List price', 'tcd-w' ); ?>&nbsp;&nbsp;<span class="p-entry-item__cprice ss_cprice"><?php usces_the_itemCpriceCr(); ?></span><?php usces_guid_tax(); ?></p>
<?php
		endif;
?>
							<p class="p-entry-item__cart-price"><?php _e( 'Selling price', 'tcd-w' ); ?>&nbsp;&nbsp;<span class="p-entry-item__price p-price ss_price"><?php usces_the_itemPriceCr(); ?></span><?php usces_guid_tax(); ?></p>
<?php
		usces_the_itemGpExp();
?>
